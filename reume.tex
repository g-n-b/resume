...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
\resumeItem{Leveraged \textbf{Kafka} for asynchronous data processing, increasing service reliability by \underline{95\%}}
\resumeItem{Designed and implemented scalable, modular \textbf{Java Spring Boot} microservices to enhance system performance and reliability}
\resumeItem{Implemented robust access control mechanisms to securely validate customer eligibility for API endpoints}
\resumeItem{Practiced \textbf{Agile development} methodologies as part of a Scrum team, delivering high-quality software iteratively}
...
\resumeItem{Developed and utilized \textbf{Splunk} dashboards to monitor feature releases, promptly identifying and resolving issues}
